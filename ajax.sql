...
--
-- Client :  localhost
-- Généré le :  Lun 18 Décembre 2023 à 22:32
...
INSERT INTO `equipe` (`id`, `nom`, `ville`, `img`) VALUES
(1, 'Stade Toulousain', 'Toulouse', 'logo\\st.png'),
(2, 'ASM Clermont Auvergne', 'Clermont-Ferrand', 'logo\\asm.png'),
(3, 'Racing 92', 'Paris', 'logo\\r92.png'),
(4, 'Montpellier Hérault Rugby', 'Montpellier', 'logo\\mhr.png'),
(5, 'Stade Rochelais', 'La Rochelle', 'logo\\lr.png'),
(6, 'Castres Olympique', 'Castres', 'logo\\co.png'),
(7, 'Union Bordeaux Bègles', 'Bordeaux', 'logo\\ubb.png'),
(8, 'RC Toulonnais', 'Toulon', 'logo\\rct.png'),
(9, 'Stade Français Paris', 'Paris', 'logo\\sf.png'),
(10, 'Section Paloise', 'Pau', 'logo\\sp.png'),
(11, 'Brive', 'Brive-la-Gaillarde', 'logo\\cab.png'),
(12, 'Aviron Bayonnais', 'Bayonne', 'logo\\ab.png'),
(13, 'Lyon OU', 'Lyon', 'logo\\lou.png'),
(14, 'Grenoble', 'Grenoble', 'logo\\usap.png');
...
--
-- Contenu de la table `matchrugby`
--
